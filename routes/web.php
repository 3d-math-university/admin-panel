...
Route::post('/change/credentials', 'ChangeCredentialsController')->name('change.credentials');
Route::get('/change/credentials', 'ChangeCredentialsController')->name('change.credentials');